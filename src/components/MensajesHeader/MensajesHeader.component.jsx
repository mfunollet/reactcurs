...
export default function MensajesHeader(props) {
  ...
  return (
    <div className="MensajesHeader">
      <Formik initialValues={initialValues} onSubmit={props.clickNuevo} validationSchema={validaciones}>
        ...
        <form onSubmit={handleSubmit} className="Formulario">
          ...
          <input className="Elemento" placeholder="E-mail" type="email"
                name="email" onChange={handleChange} value={values.email} />
           {errors.email ? (<div>{errors.email}</div>) : null}

          <input className="Elemento" placeholder="Mensaje" type="text"
